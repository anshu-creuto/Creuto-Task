...
export const navData = [
  ...
  {
    items: [
      { title: 'Add task', path: '/bookings', icon: ICONS.course },
      { title: 'Search', path: '', icon: ICONS.order },
      { title: 'Inbox', path: '/inbox', icon: ICONS.chat },
      { title: 'Upcoming', path: '/upcoming', icon: ICONS.banking },
      { title: 'Filters & Labels', path: '/filters-labels', icon: ICONS.label },
    ],
  },
  {
